...
<div class="container py-4">
    ...
    <nav class="breadcrumb-custom" aria-label="breadcrumb">
        <a href="{{ route('programas.index') }}"><i class="bi bi-house-fill me-1"></i> Programas</a>
        <span class="mx-2">/</span>
        <span class="text-muted">Editar Programa</span>
    </nav>

    <!-- Header -->
    <div class="header-section">
        <h1><i class="bi bi-pencil-square"></i> Editar Programa</h1>
        <p>Actualiza la información del programa académico</p>
    </div>
    ...
    <div class="info-box">
        ...
        <div class="info-box-content">
            ...
            <div class="info-box-text">
                Modifica los datos del programa según sea necesario. Los cambios se aplicarán inmediatamente a todas las fichas asociadas.
            </div>
        </div>
    </div>
    ...
    <div class="form-container">
        <form action="{{ route('programas.update', $programa) }}" method="POST" novalidate>
            @csrf @method('PUT')
            ...
            <div class="form-group">
                ...
                >
                    ...
                    @foreach($areas as $area)
                        <option value="{{ $area->id }}" {{ old('areas_id', $programa->areas_id) == $area->id ? 'selected' : '' }}>
                            {{ $area->nombre }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="button-group">
                <button type="submit" class="btn-custom btn-primary">
                    <i class="bi bi-check-circle-fill"></i> Actualizar Programa
                </button>
