...
<div class="container py-4">
    ...
    <nav class="breadcrumb-custom" aria-label="breadcrumb">
        <a href="{{ route('usuarios.index') }}"><i class="bi bi-house-fill me-1"></i> Usuarios</a>
        <span class="mx-2">/</span>
        <span class="text-muted">Editar Usuario</span>
    </nav>

    <!-- Header -->
    <div class="header-section">
        <h1><i class="bi bi-person-gear"></i> Editar Usuario</h1>
        <p>Actualiza la información y permisos del usuario</p>
    </div>
    ...
    <div class="info-box">
        ...
        <div class="info-box-content">
            ...
            <div class="info-box-text">
                Modifica los datos del usuario según sea necesario. Si deseas cambiar la contraseña, completa el campo de "Nueva contraseña".
            </div>
        </div>
    </div>
    ...
    <div class="form-container">
        <form action="{{ route('usuarios.update', $usuario) }}" method="POST" novalidate>
            ...
            <!-- Rol -->
            <div class="form-group">
                <label class="form-label" for="rol_id">
                    Rol del Usuario
                    <span class="required">*</span>
                </label>
                <select
