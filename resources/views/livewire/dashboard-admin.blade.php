        ...
        <div class="col-md-6 col-lg-3">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h4 class="stat-value">{{ $usuariosCount }}</h4>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h4 class="stat-value">{{ $fichasCount }}</h4>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h4 class="stat-value">{{ $programasCount }}</h4>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h4 class="stat-value">{{ $eppsCount }}</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="dashboard-card-improved">
                ...
                <div class="card-stats">
                    <span class="badge bg-light text-dark">{{ $usuariosCount }} registros</span>
                </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="dashboard-card-improved">
                ...
                <div class="card-stats">
                    <span class="badge bg-light text-dark">{{ $fichasCount }} registros</span>
                </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="dashboard-card-improved">
                ...
                <div class="card-stats">
                    <span class="badge bg-light text-dark">{{ $programasCount }} registros</span>
                </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="dashboard-card-improved">
                ...
                <div class="card-stats">
                    <span class="badge bg-light text-dark">{{ $eppsCount }} registros</span>
                </div>
