...
<div class="container py-4">
    ...
    <nav class="breadcrumb-custom" aria-label="breadcrumb">
        <a href="{{ route('fichas.index') }}"><i class="bi bi-house-fill me-1"></i> Fichas</a>
        <span class="mx-2">/</span>
        <span class="text-muted">Editar Ficha</span>
    </nav>

    <!-- Header -->
    <div class="header-section">
        <h1><i class="bi bi-pencil-square"></i> Editar Ficha</h1>
        <p>Actualiza la información de la ficha de formación</p>
    </div>
    ...
    <div class="info-box">
        ...
        <div class="info-box-content">
            ...
            <div class="info-box-text">
                Modifica los datos de la ficha según sea necesario. Los cambios se aplicarán inmediatamente a todos los registros asociados.
            </div>
        </div>
    </div>
    ...
    <div class="form-container">
        <form action="{{ route('fichas.update', $ficha) }}" method="POST" novalidate>
            @csrf @method('PUT')
            ...
            <div class="form-group">
                ...
                >
                    ...
                    @foreach($programas as $programa)
                        <option value="{{ $programa->id }}" {{ old('programas_id', $ficha->programas_id) == $programa->id ? 'selected' : '' }}>
                            {{ $programa->nombre }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="button-group">
                <button type="submit" class="btn-custom btn-primary">
                    <i class="bi bi-check-circle-fill"></i> Actualizar Ficha
                </button>
